...
In these notes I hope to give the complete walkthrough from first principles to Gödel's first incompleness theorems. My notes follow the roadmap of [cite:@barnes-mack-2013], which is a fantastic source to learn all this from. Ultimately a careful study requires reading that book; the notes below are expository and can be considered as a companion.
